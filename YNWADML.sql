...
INSERT INTO prc_clientes (usuario_cliente, clave_cliente, nombre_cliente, apellido_cliente, email_cliente, pin_cliente, estado_cliente) VALUES
('cliente01', 'claveCliente01', 'Ana', 'González', 'ana.gonzalez@example.com', '123456', 1),
('cliente02', 'claveCliente02', 'Pedro', 'López', 'pedro.lopez@example.com', '234567', 1),
('cliente03', 'claveCliente03', 'María', 'Rodríguez', 'maria.rodriguez@example.com', '345678', 1),
('cliente04', 'claveCliente04', 'Carlos', 'Martínez', 'carlos.martinez@example.com', '456789', 1),
('cliente05', 'claveCliente05', 'Laura', 'Hernández', 'laura.hernandez@example.com', '567890', 1),
('cliente06', 'claveCliente06', 'Juan', 'Gómez', 'juan.gomez@example.com', '678901', 1),
('cliente07', 'claveCliente07', 'Sofía', 'Pérez', 'sofia.perez@example.com', '789012', 1),
('cliente08', 'claveCliente08', 'Fernando', 'Sánchez', 'fernando.sanchez@example.com', '890123', 1),
('cliente09', 'claveCliente09', 'Lucía', 'Flores', 'lucia.flores@example.com', '901234', 1),
('cliente10', 'claveCliente10', 'Diego', 'Ramírez', 'diego.ramirez@example.com', '012345', 1),
('cliente11', 'claveCliente11', 'Valeria', 'Torres', 'valeria.torres@example.com', '123450', 1),
('cliente12', 'claveCliente12', 'Javier', 'García', 'javier.garcia@example.com', '234561', 1),
('cliente13', 'claveCliente13', 'Marcela', 'Vargas', 'marcela.vargas@example.com', '345612', 1),
('cliente14', 'claveCliente14', 'Andrés', 'Luna', 'andres.luna@example.com', '456123', 1),
('cliente15', 'claveCliente15', 'Carolina', 'Ríos', 'carolina.rios@example.com', '561234', 1),
('cliente16', 'claveCliente16', 'Roberto', 'Cortés', 'roberto.cortes@example.com', '612345', 1),
('cliente17', 'claveCliente17', 'Luisa', 'Ortega', 'luisa.ortega@example.com', '123456', 1),
('cliente18', 'claveCliente18', 'Santiago', 'Herrera', 'santiago.herrera@example.com', '234567', 1),
('cliente19', 'claveCliente19', 'Camila', 'Iglesias', 'camila.iglesias@example.com', '345678', 1),
('cliente20', 'claveCliente20', 'Alejandro', 'Mendoza', 'alejandro.mendoza@example.com', '456789', 1),
('cliente21', 'claveCliente21', 'Isabella', 'Cabrera', 'isabella.cabrera@example.com', '567890', 1),
('cliente22', 'claveCliente22', 'Gabriel', 'Santos', 'gabriel.santos@example.com', '678901', 1),
('cliente23', 'claveCliente23', 'Mariana', 'Cruz', 'mariana.cruz@example.com', '789012', 1),
('cliente24', 'claveCliente24', 'Hugo', 'Guzmán', 'hugo.guzman@example.com', '890123', 1),
('cliente25', 'claveCliente25', 'Valentina', 'Silva', 'valentina.silva@example.com', '901234', 1);
