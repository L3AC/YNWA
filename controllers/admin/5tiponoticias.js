...
const SAVE_FORM = document.getElementById('saveForm'),
    ID_TIPONOTICIA = document.getElementById('idTipoNoticia'),
    NOMBRE_TIPONOTICIA = document.getElementById('nombreTipoNoticia'),
    ESTADO_TIPONOTICIA = document.getElementById('estadoTipoNoticia');
...
SAVE_FORM.addEventListener('submit', async (event) => {
    ...
    (ID_TIPONOTICIA.value) ? action = 'updateRow' : action = 'createRow';
...
const openUpdate = async (id) => {
    ...
    if (DATA.status) {
        ...
        // Se prepara el formulario.
        SAVE_FORM.reset();
        //EXISTENCIAS_TIPONOTICIA.disabled = true;
        // Se inicializan los campos con los datos.
        const ROW = DATA.dataset;
        ID_TIPONOTICIA.value = ROW.id_tipo_noticia;
        NOMBRE_TIPONOTICIA.value = ROW.descripcion_tipo_noticia;
        ESTADO_TIPONOTICIA.checked = ROW.estado_tipo_noticia;
    } else {
        sweetAlert(2, DATA.error, false);
    }
}
